...
export class RecipeEditComponent implements OnInit {
  ...
  onSubmit(){
    if (this.editMode) {
      ...
      this.recipeService.updateRecipeAPICall(this.id, this.recipeForm.value);
    } else {
      this.recipeService.addRecipe(this.recipeForm.value);
      this.recipeService.addRecipeAPICall(this.recipeForm.value);
    }
    
    //this.dsService.storeRecipes();
    //this.dsService.storeRecipesToSqlExpress();
    this.onCancel();
  }
